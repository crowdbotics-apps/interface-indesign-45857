"""
Django settings for interface_indesign_45857 project.
...
ROOT_URLCONF = 'interface_indesign_45857.urls'
...
WSGI_APPLICATION = 'interface_indesign_45857.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "interface_indesign_45857 API",
    "DESCRIPTION": "API documentation for interface_indesign_45857 App",
    "VERSION": "v1",
}
